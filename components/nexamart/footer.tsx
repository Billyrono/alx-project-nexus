  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div
          className={`grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 mb-10 sm:mb-16 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          {/* Brand */}
          <div className="col-span-2 md:col-span-1 flex flex-col items-center text-center">
            <div className="flex flex-col items-center mb-6">
              <span className="font-serif font-bold italic text-3xl sm:text-5xl text-foreground leading-none mb-1">
                NexaMart
              </span>
